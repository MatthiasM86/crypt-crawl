...
## Ideen-Backlog (aus plan.md Punkt 7, Ziel 5–8 Typen)

- **Schild-Tank:** langsam, frontal immun (Schild-Winkel prüfen in
  `take_damage` via Winkel zwischen Facing und source_position) — erzwingt
  Dash hinter ihn oder Slam-Knockback.
- **Beschwörer:** flieht wie der Kultist, beschwört statt zu schießen alle
  paar Sekunden 1–2 Brutes (Cap!) — Priorität-Ziel-Gefühl.
